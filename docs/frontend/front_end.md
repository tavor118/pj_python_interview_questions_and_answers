...
### Які технології використовуються у фронтенді? [❄️1/100]
...
### Які методи оптимізації можна використовувати для прискорення завантаження веб-сторінок? [❄️1/100]
...
### Що таке компонентний підхід у розробці веб-додатків? [❄️1/100]

Компонентний підхід у розробці веб-застосунків передбачає створення програми з незалежних 
компонентів, кожен з яких виконує певну функцію. 
Компоненти можуть бути повторно використані в різних частинах програми, що спрощує його 
