...
### Rich vs Anemic Domain Model [💡10/100]
...
### DDD і масові операції (bulk operations) [❄️1/100]
...
що конфліктує з CQRS - див. вище), масове оновлення - це **запис**, тож повторне
...
### У чому різниця між стратегічним і тактичним рівнями DDD? [❄️5/100]
...
### Що таке Bounded Context і як він пов'язаний з Ubiquitous Language? [💡13/100]
...
### Як інтегрувати різні bounded contexts? [❄️2/100]
...
### Anti-Corruption Layer (ACL) [❄️5/100]
...
### Інші Context Mapping патерни: Shared Kernel, Customer/Supplier, Conformist, Partnership [❄️3/100]
