...
### Inversion of Control (IoC): бібліотека проти фреймворку [❄️3/100]
...
### Hexagonal vs onion архітектура [❄️6/100]
...
### Transactional Outbox Pattern [❄️8/100]
...
### Що таке ідемпотентність? [💡11/100]
...
### Bulkhead (ізоляція ресурсів) [❄️1/100]
...
### Як зрозуміти, що застосунок зламався? [❄️8/100]
