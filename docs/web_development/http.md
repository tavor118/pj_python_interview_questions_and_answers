...
### Версії HTTP: 1.0, 1.1, 2, 3 [❄️1/100]
...
### Аутентифікація та авторизація [❄️3/100]
...
### Що таке WebSocket і де може використовуватися? [❄️1/100]
...
### Що таке JWT (JSON Web Token) [❄️2/100]
