...
### Що відбувається, коли ви вводите URL-адресу в браузері та натискаєте Enter? [❄️1/100]
...
### Чим відрізняються HTTP і HTTPS [❄️1/100]
...
### Що швидше перевірити при авторизації - JWT чи сесію, і чому? [❄️1/100]
...
### Що таке WebSocket і де може використовуватися? [❄️2/100]
...
### Що таке JWT (JSON Web Token) [❄️3/100]
