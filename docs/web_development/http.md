...
### Що відбувається, коли ви вводите URL-адресу в браузері та натискаєте Enter? [❄️2/100]
...
### Версії HTTP: 1.0, 1.1, 2, 3 [❄️3/100]
...
### Чим відрізняються HTTP і HTTPS [❄️3/100]
...
### Аутентифікація та авторизація [❄️6/100]
...
### Що швидше перевірити при авторизації - JWT чи сесію, і чому? [❄️3/100]
...
### Що таке WebSocket і де може використовуватися? [💡10/100]
...
### Що таке JWT (JSON Web Token) [💡10/100]
