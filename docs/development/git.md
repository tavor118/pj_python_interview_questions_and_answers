...
### Що таке Git? Основні поняття [❄️1/100]
...
### У чому різниця `git merge` та `git rebase`? [❄️7/100]
...
### Що таке `сherry pick` в Git? [❄️2/100]
...
### Що таке pre-commit check [❄️1/100]
