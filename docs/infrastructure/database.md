...
### Які типи баз даних існують? [💡17/100]
...
### Чим Реляційні БД відрізняються від NoSQL БД? [💡23/100]
...
### Застосування RDB (реляційних баз даних) та NoSQL [❄️3/100]
...
### Наведіть приклади РБД та NoSQL БД [🔥39/100]
...
### Яку базу даних використовувати у проекті? [❄️4/100]
...
### Яка різниця між PostgreSQL і MySQL [❄️8/100]
...
### Які типи зв'язків бувають в БД? [💡18/100]
...
### Що таке індекси? Навіщо вони потрібні? Як вони працюють? [💡27/100]
...
### Часткові індекси (partial indexes) [❄️6/100]
...
### В яких випадках використовується `CREATE INDEX CONCURRENTLY` [❄️2/100]
...
### Що таке транзакція? Що таке ACID? [🔥50/100]
...
### Які команди управління транзакціями ви знаєте [❄️4/100]
...
### Що таке рівні ізоляції транзакцій. Які вони бувають [🔥39/100]
...
### Snapshot Isolation і Serializable Snapshot Isolation (SSI) [❄️3/100]
...
### Що таке VACUUM в PostgreSQL [❄️9/100]
...
### `pg_cron`: планувальник задач у PostgreSQL [❄️2/100]
...
### Як виявити повільний SQL запит? [❄️9/100]
...
### Що таке профілювання запитів? [💡10/100]
...
### Що таке Deadlock? Як їх уникати? [❄️9/100]
...
### Партиціювання та шардування [💡28/100]
...
### Яка різниця між OLTP та OLAP? [❄️8/100]
...
### Redis: однопотоковий engine та атомарність через Lua [❄️6/100]
...
### Безпечна зміна схеми великих таблиць (online DDL) [❄️6/100]
