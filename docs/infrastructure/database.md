...
### Яка різниця між BASE і ACID? [❄️6/100]
...
### Що таке індекси? Навіщо вони потрібні? Як вони працюють? [❄️4/100]
...
### Які популярні типи індексів існують? [❄️4/100]
...
### Складені (multi-column) індекси [❄️1/100]
...
### Часткові індекси (partial indexes) [❄️1/100]
...
### Що таке seq-scan? Коли він виконується, навіть якщо є індекси? [❄️2/100]
...
### Що таке транзакція? Що таке ACID? [❄️6/100]
...
### Що таке рівні ізоляції транзакцій. Які вони бувають [❄️6/100]
