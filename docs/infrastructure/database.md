...
### Що таке бази даних і для чого вони потрібні? [🔥40/100]
...
### Які типи баз даних існують? [💡20/100]
...
### Чим Реляційні БД відрізняються від NoSQL БД? [💡26/100]
...
### Яка різниця між BASE і ACID? [💡12/100]
...
### Які типи зв'язків бувають в БД? [💡20/100]
...
### Що таке індекси? Навіщо вони потрібні? Як вони працюють? [💡28/100]
...
### Які популярні типи індексів існують? [🔥53/100]
...
### Складені (multi-column) індекси [💡12/100]
...
### Що таке seq-scan? Коли він виконується, навіть якщо є індекси? [💡10/100]
...
### Що таке транзакція? Що таке ACID? [🔥51/100]
...
### Що таке рівні ізоляції транзакцій. Які вони бувають [🔥40/100]
...
### Що таке курсор і навіщо він потрібен [💡17/100]
...
### Що таке Deadlock? Як їх уникати? [💡11/100]
...
### Партиціювання та шардування [💡29/100]
