...
### Яка різниця між BASE і ACID? [❄️4/100]
...
### Що таке індекси? Навіщо вони потрібні? Як вони працюють? [❄️2/100]
...
### Які популярні типи індексів існують? [❄️2/100]
...
### Що таке seq-scan? Коли він виконується, навіть якщо є індекси? [❄️1/100]
...
### Що таке транзакція? Що таке ACID? [❄️4/100]
...
### Що таке рівні ізоляції транзакцій. Які вони бувають [❄️4/100]
...
### Що таке VACUUM в PostgreSQL [❄️2/100]
...
### Що таке Deadlock? Як їх уникати? [❄️2/100]
...
### Партиціювання та шардування [❄️2/100]
