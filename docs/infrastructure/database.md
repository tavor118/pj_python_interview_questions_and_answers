...
### Що таке індекси? Навіщо вони потрібні? Як вони працюють? [❄️5/100]
...
### Які популярні типи індексів існують? [❄️5/100]
...
### Складені (multi-column) індекси [❄️2/100]
...
### Що таке seq-scan? Коли він виконується, навіть якщо є індекси? [❄️3/100]
...
### Що таке транзакція? Що таке ACID? [❄️8/100]
...
### Що таке рівні ізоляції транзакцій. Які вони бувають [❄️7/100]
...
### Партиціювання та шардування [❄️3/100]
...
### Яка різниця між OLTP та OLAP? [❄️1/100]
