...
### Які типи баз даних існують? [❄️3/100]
...
### Що таке індекси? Навіщо вони потрібні? Як вони працюють? [❄️6/100]
...
### Які популярні типи індексів існують? [💡10/100]
...
### Складені (multi-column) індекси [❄️5/100]
...
### Часткові індекси (partial indexes) [❄️2/100]
...
### Що таке seq-scan? Коли він виконується, навіть якщо є індекси? [❄️5/100]
...
### Що таке транзакція? Що таке ACID? [💡11/100]
...
### Що таке рівні ізоляції транзакцій. Які вони бувають [❄️9/100]
...
### Що таке VACUUM в PostgreSQL [❄️3/100]
...
### Що таке Deadlock? Як їх уникати? [❄️3/100]
...
### Партиціювання та шардування [❄️5/100]
...
### Яка різниця між OLTP та OLAP? [❄️3/100]
...
### Redis: однопотоковий engine та атомарність через Lua [❄️1/100]
