...
### Які готові реалізації MQ ви знаєте [🔥35/100]
...
### Особливості роботи з Redis [💡18/100]
...
### Які структури даних є в Redis? [💡12/100]
...
### Типи обмінників (exchanges) у RabbitMQ
...
### Як Kafka працює під капотом? [💡26/100]
...
### Що таке топік і партиція в Kafka? [💡13/100]
