...
### Які структури даних є в Redis? [❄️2/100]
...
### Типи обмінників (exchanges) у RabbitMQ [❄️2/100]
...
### Dead-letter exchange (DLX) в RabbitMQ [❄️3/100]
...
### Як Kafka працює під капотом? [❄️5/100]
...
### Що таке топік і партиція в Kafka? [❄️3/100]
...
### Ідемпотентні консьюмери [❄️2/100]
