...
Для створення метакласу використовується спеціальний метод `__metaclass__` в класі. 
Цей метод визначає поведінку метакласу і виконується при створенні класу.
...
### Що таке `type`. Як працює пошук метакласу при створенні об'єкта [❄️2/100]
