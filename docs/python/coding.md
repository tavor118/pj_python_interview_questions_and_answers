...
### Вивести найбільші 2 числа для словника [❄️1/100]
...
### Функція перевірки простого числа [❄️4/100]
...
### Функція перевірки, чи рядок є паліндромом [❄️3/100]
...
### Генератор для чисел Фібоначчі [❄️1/100]
...
### Рекурсивна функція для чисел Фібоначчі [❄️1/100]
...
### Рекурсивна функція для чисел Фібоначчі з кешем [❄️5/100]
...
### Декоратор для заміру часу виконання функції [❄️7/100]
...
### Декоратора, який буде перехоплювати помилки, і повторіть функцію максимум N раз [❄️2/100]
...
### Спискові і словникові вирази [💡21/100]
...
### Знайти трійку найуживаніших слів у тексті [❄️2/100]
...
### Чи можна використати клас як ключ в словнику [❄️3/100]
...
### Дескриптор з метою запобігання видаленню атрибутів [❄️1/100]
...
### Пошук слова в матриці (DFS + backtracking) [❄️2/100]
...
### Максимум у кожному вікні (монотонний дек) [❄️1/100]
...
### Перемістити нулі в кінець (два вказівники, in-place) [❄️2/100]
...
### Декоратор обмеження частоти викликів (rate limit) [❄️1/100]
...
### Кодування довжин серій (run-length encoding) [❄️1/100]
...
### Two Sum (пара з заданою сумою) [❄️2/100]
