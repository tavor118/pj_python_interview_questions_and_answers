...
### Чому використання змінних об'єктів як параметрів за замовчуванням погана практика [❄️5/100]
...
### Що таке лямбди. Які їх особливості [❄️8/100]
...
### Що таке замикання (Closure) [💡10/100]
...
### Чиста функція (pure function) [❄️1/100]
