...
### Контекстний менеджер (Context manager) [🔥64/100]
...
### Що таке простори імен в Python? LEGB [💡18/100]
...
### Що таке локальні та глобальні змінні в Python? `global`, `nonlocal` [🔥33/100]
