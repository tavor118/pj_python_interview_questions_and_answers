...
### Контекстний менеджер (Context manager) [🔥58/100]
...
### Що таке простори імен в Python? LEGB [💡13/100]
...
### Що таке локальні та глобальні змінні в Python? `global`, `nonlocal` [💡26/100]
