...
### Як користуватися функцією `open` [💡15/100]
...
### З чого складається процес закриття файлів [💡18/100]
...
### Чи є файлові об'єкти контекстними менеджерами [💡10/100]
