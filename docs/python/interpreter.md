...
Тобто, коли запускаємо файл з Python-кодом,  інтерпретатор ініціалізує основний потік виконання, який відповідає за запуск і виконання програми. Основний потік створює об'єкт `__main__`, що містить глобальний простір імен, і починає виконувати код, читаючи його рядок за рядком, компілюючи у байт-код і передаючи на виконання віртуальній машині Python
