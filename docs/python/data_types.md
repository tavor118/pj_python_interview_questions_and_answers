...
### Які типи даних є в Python [❄️3/100]
...
### Яка різниця між змінними і незмінними типами даних в Python? [💡18/100]
...
### `int` як ціле з довільною точністю
