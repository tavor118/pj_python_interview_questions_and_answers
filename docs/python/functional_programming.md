...
### Що таке об'єкт першого класу [❄️3/100]
...
### Опишіть функції `map`, `reduce`, `filter` модуля functools [❄️1/100]
...
### Чим функціональне програмування відрізняється від ООП? [❄️1/100]
