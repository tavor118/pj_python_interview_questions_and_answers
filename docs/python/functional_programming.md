...
### Що таке функціональне програмування [💡20/100]
...
### Підтримка функціонального програмування в Python [💡10/100]
...
### Що таке об'єкт першого класу [💡10/100]
...
### Що таке функція вищого порядку? [💡11/100]
...
### Опишіть функції `map`, `reduce`, `filter` модуля functools [💡26/100]
