...
### Що таке функціональне програмування [💡21/100]
...
### Підтримка функціонального програмування в Python [💡11/100]
...
### Що таке об'єкт першого класу [💡11/100]
...
### Що таке функція вищого порядку? [💡12/100]
...
### Опишіть функції `map`, `reduce`, `filter` модуля functools [🔥30/100]
