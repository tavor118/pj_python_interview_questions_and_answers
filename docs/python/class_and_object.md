...
### Що робить метод `__init__`? [❄️2/100]
...
### Абстрактні класи та методи [❄️1/100]
...
### Атрибути. В чому сенс `_value`, `__value` [❄️3/100]
...
### Що таке качина типізація [💡10/100]
...
### Методи. `@staticmethod`, `@classmethod` [❄️4/100]
