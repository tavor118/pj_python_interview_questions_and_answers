...
### Що робить метод `__init__`? [💡24/100]
...
### Як отримати список атрибутів об'єкта [💡11/100]
...
### Що таке магічні методи та для чого вони потрібні [🔥60/100]
...
### Яка різниця між `__str__` та `__repr__`? [💡15/100]
...
### Які магічні методи відповідають за перетворення типів? [🔥33/100]
...
### Як у класі посилатися на батьківський клас (`super()`) [💡18/100]
...
### Чи можливе множинне наслідування [🔥37/100]
...
### Що таке проблема ромба (Diamond problem) [💡17/100]
...
### Абстрактні класи та методи [💡15/100]
...
### Атрибути. В чому сенс `_value`, `__value` [💡21/100]
...
### Що таке качина типізація [💡17/100]
...
### Що таке перевантаження оператора (overloading)? [💡10/100]
...
### Методи. `@staticmethod`, `@classmethod` [🔥34/100]
...
### Що таке властивість (`@property`)? [💡29/100]
