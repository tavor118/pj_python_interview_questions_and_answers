...
### Що робить метод `__init__`? [💡19/100]
...
### Як отримати список атрибутів об'єкта [💡10/100]
...
### Що таке магічні методи та для чого вони потрібні [🔥57/100]
...
### Яка різниця між `__str__` та `__repr__`? [💡14/100]
...
### Які магічні методи відповідають за перетворення типів? [🔥30/100]
...
### Як у класі посилатися на батьківський клас (`super()`) [💡16/100]
...
### Чи можливе множинне наслідування [🔥33/100]
...
### Що таке проблема ромба (Diamond problem) [💡16/100]
...
### Абстрактні класи та методи [💡13/100]
...
### Що таке качина типізація [💡15/100]
...
### Методи. `@staticmethod`, `@classmethod` [🔥30/100]
...
### Що таке властивість (`@property`)? [💡28/100]
