...
### Види наслідування моделей [❄️4/100]
...
### Різниця між `select_related` та `prefetch_related` [💡12/100]
...
### Що таке сигнали? Навіщо вони потрібні? Назвіть основні. [❄️2/100]
...
### Що таке Middleware, для чого, як реалізується [❄️6/100]
