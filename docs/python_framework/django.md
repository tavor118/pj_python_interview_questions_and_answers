...
проміжна таблиця з назвою `a_to_b`, яка містить ключ до A, ключ до B та додаткову 
інформацію, наприклад, час створення зв'язку.
...
Ці функції реалізовані в сторонніх пакетах
