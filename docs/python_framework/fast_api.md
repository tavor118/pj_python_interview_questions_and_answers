...
### Що приймає `Depends()` у FastAPI? Якого типу об'єкт це з погляду Python? [❄️3/100]
...
### Pydantic-схеми у FastAPI [❄️1/100]
...
### CPU-bound задачі у FastAPI: коли виносити у Celery [❄️1/100]
...
### Кастомні обробники винятків (`exception_handler`) [❄️1/100]
