...
### Переваги та недоліки FastAPI [❄️4/100]
...
### Що приймає `Depends()` у FastAPI? Якого типу об'єкт це з погляду Python? [❄️8/100]
...
### Різниця між `Depends()` та параметром `dependencies=[...]` [❄️2/100]
...
### Sync vs async ендпоінти у FastAPI [💡17/100]
...
### `BackgroundTasks` у FastAPI [❄️4/100]
...
### Pydantic-схеми у FastAPI [❄️5/100]
...
### `model_validate` у Pydantic v2 [❄️1/100]
...
### Кастомні обробники винятків (`exception_handler`) [❄️2/100]
...
### Тестування FastAPI: `TestClient` і `dependency_overrides` [❄️2/100]
